...
function setup_sideline() {
	...
	for (const label of labels) {
		...
		svg_line1.setAttribute("x2", note_offset.left - 3);
		...
		svg_line2.setAttribute("x1", note_offset.left - 3);
		svg_line2.setAttribute("y1", label_offset.top + label_offset.height + 1);
		svg_line2.setAttribute("x2", note_offset.left - 3);
		...
		svg_line3.setAttribute("stroke-width", "4px");
		svg_line3.setAttribute("stroke", "#666");
		svg_line3.setAttribute("x1", note_offset.left - 2);
		svg_line3.setAttribute("y1", note_offset.top);
		svg_line3.setAttribute("x2", note_offset.left - 2);
